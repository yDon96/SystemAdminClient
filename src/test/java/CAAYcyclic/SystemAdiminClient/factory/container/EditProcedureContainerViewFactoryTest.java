 ...
 * @author Youssef
 */
public class EditProcedureContainerViewFactoryTest {
    
    IContainerViewAbstractFactory instance;
    
    @Before
    public void setUp() {
        instance = new EditProcedureContainerViewFactory();
    }
    ...
    /**
     * Test of getBarController method, of class EditProcedureContainerViewFactory.
     */
    @Test
    ...
    /**
     * Test of getContentPanelController method, of class EditProcedureContainerViewFactory.
     */
    @Test
    public void testGetContentPanelController() {
        ...
        assertEquals(EditProcedureFormPanelController.class, result.getClass());
    }
     ...
     */
    @Test
    public void shouldGetContentPanelControllerBeNotEqualIfNotEditProcedureFormPanelController() {
        System.out.println("getContentPanelController");
        IPanelController result = instance.getContentPanelController();
