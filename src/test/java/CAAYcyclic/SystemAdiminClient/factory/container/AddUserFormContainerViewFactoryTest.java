 ...
 * @author Youssef
 */
public class AddUserFormContainerViewFactoryTest {
    
    IContainerViewAbstractFactory instance;
    
    @Before
    public void setUp() {
        instance = new AddUserFormContainerViewFactory();
    }
    ...
    /**
     * Test of getBarController method, of class AddUserFormContainerViewFactory.
     */
    @Test
    ...
    /**
     * Test of getContentPanelController method, of class AddUserFormContainerViewFactory.
     */
    @Test
    public void testGetContentPanelController() {
        ...
        assertEquals(AddUserFormPanelController.class, result.getClass());
    }
     ...
     */
    @Test
    public void shouldGetContentPanelControllerBeNotEqualIfNotAddUserFormPanelController() {
        System.out.println("getContentPanelController");
        IPanelController result = instance.getContentPanelController();
